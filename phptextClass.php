...
{	
	public function phptext($text,$textColor,$backgroundColor='',$fontSize,$imgWidth,$imgHeight,$dir,$fileName)
	{
		...
		imagettftext($im, $fontSize, 8, $x, $y, $textColor, $font, $text);
	...
	{	
		/* Settings */
		$text=$this->random();
		$font = 'C:/Windows/Fonts/timesbd.ttf';/* font */
		$textColor=$this->hexToRGB($textColor);	
		$fontSize = $imgHeight * 0.55;
	...
	/*for random string*/
	protected function random($characters=6,$letters = '#*%$&<>?23456789bcdfhkmnrstvwxz'){
		$str='';
